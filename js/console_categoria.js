    ...
    $.ajax({
        ...
        if(resp>0){
            if(resp==1){
                ...
                Swal.fire("Mensaje de advertencia","La categoria ingresada ya se encuentra registrada","warning");
            }
        }else{
    ...
    $.ajax({
        ...
        if(resp>0){
            if(resp==1){
                ...
                Swal.fire("Mensaje de advertencia","La categoria ingresada ya existe","warning");
            }
        }else{
