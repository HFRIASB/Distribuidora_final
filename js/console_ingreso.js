...
$('#tabla_ingreso').on('click','.imprimir',function(){
    ...
    window.open("../MPDF/generar_ingreso.php?codigo="+parseInt(data.ingreso_id)+"#zoom=100","Reporte Ingreso","scrollbards=NO");
})
    ...
    $.ajax({
        ...
        if(resp>0){
            Swal.fire({
                ...
                if (result.value) {
                    window.open("../MPDF/generar_ingreso.php?codigo="+parseInt(id)+"#zoom=100","Reporte Ingreso","scrollbards=NO");
